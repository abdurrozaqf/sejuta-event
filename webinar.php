	...
	<div class="header">
		<div class="container">
			...
			<ul class="header-menu" id="myTopnav">
				...
				<li><a href="unggah_webinar.php">Posting</a></li>
...
<section class="webinar" id="webinar">
		...
		<div class="container">
			<h1 style="padding-top:10px;">Selamat datang di Laman Informasi Seputar Webinar Undiksha</h1>
				...
				$select=mysqli_query($con, "SELECT * FROM webinar");
			...
			<div class="col-4">
				...
				<div class="thumbnail-box">
					<a href="<?php echo $row['link']; ?>" class="thumbnail-link">
					<div class="thumbnail-img">
						<img src="files/webinar/<?php echo $row['gambar']; ?>">
					</div>
