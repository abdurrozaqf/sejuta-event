...
<!-- Content -->
<section id="unggah" class="unggah mb-5">
...
<h1 class="text-center mb-3">Unggah</h1>
	<div class="container">
		...
		?>
  	<form action="unggah_process_lomba.php" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="form-group">
		        ...
		        <option>Media Presentasi</option>
		...
		<p class="pt-2">Sudah posting event kamu? <a href="lomba.php">Cek sekarang!</a></p>
	</div>
</section>
<!-- Content -->
